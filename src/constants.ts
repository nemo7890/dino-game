...
export const OBSTACLE_TYPES = [
  { type: 'CACTUS_SMALL', width: 17, height: 35, yPos: 105, numFrames: 0 },
  { type: 'CACTUS_LARGE', width: 25, height: 50, yPos: 90, numFrames: 0 },
  { type: 'PTERODACTYL', width: 46, height: 40, yPos: [100, 75, 50], numFrames: 2, frameRate: 1000/6 }
];
